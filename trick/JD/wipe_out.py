...
src_dir = '/home/zq610/WYZ/JD_contest/roi'
output_dir = '/home/zq610/WYZ/JD_contest/wipe_out'
...
def main():
    ...
    for pig in range(1,31):
        ...
        for pig_image in image_list:
            ...
            # print(img)
            img_shape = img.shape
            if img_shape[0]<single_threshold or img_shape[1]<single_threshold or (img_shape[0]<200 and img_shape[1]<double_threshold):
