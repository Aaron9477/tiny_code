...
int main(int argc, char**argv) {
    ...
    cv::VideoCapture capture("/media/Ubuntu/Jetson/WYZ/messing/dai.mp4");
    ...
    cv::Ptr<cv::cuda::CascadeClassifier> cascade_gpu = cv::cuda::CascadeClassifier::create("/home/ubuntu/WYZ/mess/haarcascade_frontalface_alt.xml");
